...
def create_prompt_template_management_tab(admin_db_handler):
    ...
    with gr.TabItem("Prompt Template Management"):
        ...
        task_type_selector.change(
            ...
            outputs=[selected_task, selected_model_family, version_dropdown, delete_button, template_text, template_id, feedback, placeholders_display]
        )
        ...
        selected_task.change(
            ...
            inputs=[],
            outputs=[selected_model_family, version_dropdown, delete_button, template_text, template_id, feedback, placeholders_display]
        )
                ...
                for template in existing_templates:
                    if template.template_text.strip() == template_text_val.strip():
                        ...
                        return (
                            ...
                            gr.update(choices=[str(t.version) for t in existing_templates], value=str(template.version)),
